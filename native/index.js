...
module.exports.calculateCentrality = nativeBinding.calculateCentrality
module.exports.detectCycles = nativeBinding.detectCycles
module.exports.filterEdgesByType = nativeBinding.filterEdgesByType
module.exports.findShortestPath = nativeBinding.findShortestPath
module.exports.index = nativeBinding.index
module.exports.indexWithCache = nativeBinding.indexWithCache
module.exports.dbIngest = nativeBinding.dbIngest
module.exports.kHopBfs = nativeBinding.kHopBfs
module.exports.pingEmbedder = nativeBinding.pingEmbedder
module.exports.graphKeywordSearch = nativeBinding.graphKeywordSearch
module.exports.dbHybridSearch = nativeBinding.dbHybridSearch
module.exports.dbSemanticSearch = nativeBinding.dbSemanticSearch
module.exports.dbTraverse = nativeBinding.dbTraverse
