        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "limit": { "type": "integer", "minimum": 1, "maximum": 100, "description": "Max hits per query (default 50). The result states the true total, so raise this rather than re-querying when it says more exist." },
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "limit": { "type": "integer", "minimum": 1, "maximum": 200, "description": "How many rows to display (default 50). Shorthand for range \"1-N\"." },
