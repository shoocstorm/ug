...
pub(crate) const API_ENDPOINTS: &[(&str, &[ApiEntry])] = &[
    ...
    (
        ...
        &[
            ...
            ApiEntry { method: "POST", path: "/api/tools/file_context", desc: "one file's outline, importers, imports, tests, blast radius and siblings, budgeted", availability: "always (empty if no project active)", cli_equivalent: Some("ug file_context --json") },
